...
const navigation = [
  ...
  { name: 'Ordens de Serviço', href: '/ordens', icon: MapIcon },
]
                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-primary-600 px-6 pb-4">
                    <div className="flex h-16 shrink-0 items-center">
                      <h1 className="text-white text-xl font-bold">Otimizador de Rotas</h1>
                    </div>
                            ...
                            {navigation.map((item) => (
                              <li key={item.name}>
                                ...
                                >
                                  <item.icon
                                    className={classNames(
                                      location.pathname === item.href ? 'text-white' : 'text-primary-100 group-hover:text-white',
                                      'h-6 w-6 shrink-0'
                                    )}
                                    aria-hidden="true"
                                  />
                        ...
                        <li className="mt-auto">
                          <div className="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white">
                            ...
                            <div className="flex flex-col">
                              <span>{team?.name}</span>
                              <span className="text-xs text-primary-100">Código: {team?.code}</span>
                            </div>
                          </div>
                        </li>
                      </ul>
